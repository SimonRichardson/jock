describe("Injector", function () {
    ...
    describe("when injecting object getInstance is not null", function () {
        ...
        it("module is not null when inject into Injector", function () {
            expect(Injector.initialize(MockModule())).not.toBeNull();
        });
    });
    ...
    describe("when injecting a Provider", function () {
        ...
        var IMockProvider = Object.create({});
        var IMockProviderObject = Object.create({});

        var ProvidedObject = Object.create({});

        var MockProvider = Object.create(Provider, {
            get: {
                get: function(){
                    return Object.create(ProvidedObject);
                }
            }
        });
